...
//useremo la libreria java.logging, andando a configurare il nostro log tramite un file di configurazione
import java.util.*;
import java.io.*;
import java.math.*;
import java.util.logging.*;

public class Cap8_TT {
	private static final LogManager logManager = LogManager.getLogManager();
	private static final Logger LOGGER = Logger.getLogger("Cap8_TT");
