...
//    }
	...
	@Test
	public void testPolilineaCorretta() {
		try {
	...
	@Test
	public void testPolilineaCorrettaConQuattroPunti() {
		try {
	...
	@Test
	public void testPolilineaSenzaSegmenti() {
		try {
	...
	@Test
	public void testPolilineaConUnSoloSegmento() {
		try {
	...
	public void testPolilineaConDueSegmentiNonConsecutiviNelCostruttore() {
		try {
	...
	public void testPolilineaConTreSegmentiNonConsecutiviNelCostruttore() {
		try {
	...
	@Test
	public void testPolilineaCorrettaAggiungendoUnSegmentoConsecutivo() {
		try {
	...
	@Test
	public void testPolilineaScorrettaAggiungendoUnSegmentoNonConsecutivo() {
		try {
